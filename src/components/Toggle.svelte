<script>
	...
	onMount(() => {
		...
		mode.addEventListener('click', () => {
			const themeClass = doc.classList;
			if (themeClass.contains('light')) {
				themeClass.remove('light');
				themeClass.add('dark');
			} else if (themeClass.contains('dark')) {
				themeClass.remove('dark');
				themeClass.add('brown');
			} else if (themeClass.contains('brown')) {
				themeClass.remove('brown');
...
<button class="toggle" type="button" aria-label="toggle">
	<span />
